...
if (typeof module != 'undefined' && module.exports) {
  var magVar = new WorldMagneticModel();
  module.exports = function(position, altitude) {
    altitude = altitude || 0;
    return magVar.declination(altitude * 0.0003048, position.latitude, position.longitude, 2014.999);
  };
}
