...
(function (undefined) {
  ...
  var commandsList = [];
  var processSpeech = null;
  var aggregateCommands = null;
  var selectCommands = null;
  var recognition;
  ...
  root.annyang = {
    ...
    init: function(commands, resetCommands) {
      ...
      recognition.onresult  = function(event) {
        ...
        for (var i = 0; i<results.length; i++) {
          ...
          if (processSpeech) {
            aggregateCommands(commands, processSpeech(commandText));
          } else {
    ...
    processSpeechWith: function(fn, fn2, fn3) {
      processSpeech = fn;
      aggregateCommands = fn2;
      selectCommands = fn3;
    },
